...
export function EmptyState({
	...
	return (
		<div className="flex flex-col items-center justify-center py-12 text-center">
			...
			{description && (
				<p className="text-xs font-mono lowercase text-muted-foreground/70 mb-4">
					{description}
				</p>
			)}
...
export function Divider({
	...
	return orientation === "horizontal" ? (
		<div
			className={cn("border-t border-border", marginClasses[margin].horizontal)}
		/>
	) : (
		<div
			className={cn("border-l border-border", marginClasses[margin].vertical)}
		/>
	);
}
