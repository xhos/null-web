		...
		>
			{isLoading ? (
				...
				<div className="relative flex-1 overflow-hidden">
					<div
						className={`absolute top-0 left-0 right-0 h-16 pointer-events-none bg-gradient-to-b from-card via-transparent to-transparent z-10 transition-opacity duration-200 ${showTopFade ? "opacity-100" : "opacity-0"}`}
					/>
					<div
					...
					<div
						className={`absolute bottom-0 left-0 right-0 h-16 pointer-events-none bg-gradient-to-b from-transparent via-transparent to-card transition-opacity duration-200 ${showBottomFade ? "opacity-100" : "opacity-0"}`}
					/>
				</div>
			)}
		</Card>
