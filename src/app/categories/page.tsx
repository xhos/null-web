...
import { Card, ErrorMessage, LoadingSkeleton } from "@/components/lib";
import {
	PageContainer,
	PageContent,
	PageHeaderWithTitle,
...
import { type CategoryRow, createColumns } from "./columns";
		...
		<PageContainer>
			<PageContent>
				...
				<DeleteDialog
					...
					childCount={
						deletingCategory
							? countChildren(deletingCategory.slug, categories)
							: 0
					}
