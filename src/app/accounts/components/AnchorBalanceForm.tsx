...
export default function AnchorBalanceForm({
	...
	const [formData, setFormData] = useState({
		amount: currentBalance?.units
			? parseFloat(currentBalance.units.toString()).toString()
			: "",
			...
			<form onSubmit={handleSubmit}>
				<VStack spacing="lg">
					...
					<Text size="sm" color="muted">
						This sets the reference balance for this account at a specific point
						in time. It&apos;s used to calculate running balances for
						transactions.
					</Text>
